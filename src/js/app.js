...
import { openCh, modalCh, closeCh, openMa, modalMa, closeMa, openBa, modalBa, closeBa, openTe, modalTe, closeTe, openDo, modalDo, closeDo, openDa, modalDa, closeDa, imagenes, imagenActiva, imagenMain, imagenes2, imagenActiva2, imagenMain2, slider, btnLeft2, btnLeft, btnRight, slider2, btnRight2 } from './dom/var-actions'
